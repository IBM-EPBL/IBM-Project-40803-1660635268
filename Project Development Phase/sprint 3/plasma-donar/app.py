...
def donar_registration():
    if request.method=="GET":
        ...
        try:
            ...
            with sql.connect("donar.db") as connection:
                cursor=connection.cursor()
                cursor.execute("INSERT INTO DONARS (name,phone,age,blood_group,weight,parasitic,hiv,blood_disease,drugs,vaccine,overall_health,donated_plasma,date) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",(name,phone,age,blood,weight,parasitic,hiv,disease,drugs,vaccine,health,donated,date))
